...
const features = ['Fitted at home','Fitted at work','Mobile van call-outs','Same-day availability','No garage waiting room','Fleet yard support'];
  ...
  return (
    <main style={pageStyle}>
      ...
      <section style={heroStyle}>
        <span style={badgeStyle}>Mobile tyre fitting</span>
        <h1 style={titleStyle}>Tyres fitted at home, work or roadside</h1>
        <p style={leadStyle}>NeedATyre brings tyre fitting to you. Search tyres online, choose mobile fitting, then book a time that suits your day.</p>
        ...
        <section style={darkBox}>
          <h2 style={darkTitle}>How mobile fitting works</h2>
          <p style={darkText}>Enter your registration or tyre size, choose your tyres, select mobile fitting, then confirm your address and appointment slot. A fitter attends your location and fits the tyres without you needing to visit a garage.</p>
          <Link href="/booking" style={yellowButton}>Book mobile fitting</Link>
        </section>
