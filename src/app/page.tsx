    ...
    <main style={styles.page}>
      ...
      <section style={styles.hero}>
        ...
        <aside style={styles.panel}>
          ...
          <ul style={styles.list}><li>✓ Transparent fitted pricing</li><li>✓ Mobile and garage fitting</li><li>✓ Emergency tyre help</li><li>✓ Fleet support available</li></ul>
        </aside>
      </section>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  hero: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 36, padding: "78px 6% 58px", background: "radial-gradient(circle at top right,#99f6e4,transparent 32%),linear-gradient(135deg,#fefce8,#ecfeff)" },
  heroText: { maxWidth: 820 }, badge: { display: "inline-flex", background: "#bef264", borderRadius: 999, padding: "9px 15px", fontWeight: 900, textTransform: "uppercase", fontSize: 12, marginBottom: 18 },
  ...
  panelTitle: { fontSize: 34, lineHeight: 1, letterSpacing: "-.04em" }, panelText: { color: "#cbd5e1", lineHeight: 1.6 }, list: { listStyle: "none", padding: 0, lineHeight: 2, fontWeight: 800 },
  services: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 22, padding: "34px 6% 80px" },
  card: { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 28, padding: 28, boxShadow: "0 18px 50px rgba(15,23,42,.08)" }, number: { color: "#0891b2", fontSize: 28, fontWeight: 900 }, muted: { color: "#64748b", lineHeight: 1.6 },
  dark: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 36, padding: "80px 6%", background: "#111827", color: "#fff" }, sectionTitle: { fontSize: 46, lineHeight: 1, letterSpacing: "-.05em", margin: "12px 0 18px" }, darkText: { color: "#cbd5e1", fontSize: 18, lineHeight: 1.6 }, grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(190px,1fr))", gap: 14 }, gridItem: { background: "rgba(255,255,255,.08)", border: "1px solid rgba(255,255,255,.12)", borderRadius: 18, padding: 18, fontWeight: 800 },
  cta: { textAlign: "center", padding: "80px 6%", background: "#facc15" }, ctaTitle: { fontSize: 50, letterSpacing: "-.05em", margin: 0 }, ctaButton: { display: "inline-flex", marginTop: 24, background: "#111827", color: "#fff", textDecoration: "none", padding: "16px 28px", borderRadius: 999, fontWeight: 900 }
};
